...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageHome = (function (_Component) {
	    _inherits(PageHome, _Component);
	
	    function PageHome(props) {
	        _classCallCheck(this, PageHome);
	
	        _get(Object.getPrototypeOf(PageHome.prototype), 'constructor', this).call(this, props);
	    }
	    ...
	    _createClass(PageHome, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            if (home.list.length == 0) {
	                dispatch((0, _actionsHome.fetchIndexList)());
	            }
	        }
	    }, {
	        ...
	        key: 'handleClick',
	        value: function handleClick(nextReddit) {}
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_componentsList2['default'], { list: home && home.list || [] })
	            );
	        }
	    }]);
...
//# sourceMappingURL=home.min.js.map?ver=e00d4b93