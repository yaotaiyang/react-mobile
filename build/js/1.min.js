	    ...
	    _createClass(Index, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            if (index.list.length == 0) {
	                dispatch((0, _actionsIndex.fetchIndexList)(index));
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_componentsList2['default'], { list: index.list })
	            );
	        }
	    }]);
...
//# sourceMappingURL=1.min.js.map?ver=b0313c7b